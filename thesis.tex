...
do typoych sposobów parsingu nasz model nie wymaga żadnego pre-processingu danych,
...
part-of-speech tagging. Additionally we present a models trained jointly on two
